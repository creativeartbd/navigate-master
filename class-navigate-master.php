...
/**
 * Main Navigate Master Class
 *
 * The init class that runs the Navigate Master plugin.
...
final class Navigate_Master {
	...
	public function i18n() {
		load_plugin_textdomain( 'navigate-master' );
	}
